    ...
    <div className="container mx-auto max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="stat bg-base-100 shadow">
          ...
          <div className="stat-value text-sm">{formatDateTime(insight.date)}</div>
        </div>
        ...
        <div className="stat bg-base-100 shadow">
          ...
          <div className="stat-value text-sm">{insight.category}</div>
        </div>
        ...
        <div className="stat bg-base-100 shadow">
          ...
          <div className="stat-value text-sm">{insight.platform || 'All Platforms'}</div>
        </div>
        ...
        <div className="stat bg-base-100 shadow">
          ...
          <div className="stat-value text-sm">{insight.actionable ? 'Actionable' : 'Informational'}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <div className="flex items-center justify-between mb-6">
                <h2 className="card-title text-xl">Insight Details</h2>
                {insight.trend && (
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h3 className="card-title mb-4">Information</h3>
